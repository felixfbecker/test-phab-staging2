...
type commentListReader struct {
	...
	pos, end token1.Position // source interval of comment group at current index
}
...
//
func (s *nodeStack) pop(pos token1.Pos) (top Node) {
	i := len(*s)
...
//
func NewCommentMap(fset *token1.FileSet, node Node, comments []*CommentGroup) CommentMap {
	if len(comments) == 0 {
